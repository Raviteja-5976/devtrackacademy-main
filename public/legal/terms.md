...
Any legal action or proceeding arising under these Terms shall be subject to the exclusive jurisdiction of the courts located in **Hyderabad, Telangana, India**.

---

## 2. Eligibility & Account Security

1. **Age Requirement:** You must be at least 18 years of age to register for an account or purchase Services on the Platform. If you are under 18, you may only use our Services under the supervision of a parent or legal guardian who agrees to be bound by these Terms.
2. **Account Accuracy:** You agree to provide accurate, current, and complete information during registration and keep your account details updated.
3. **Credentials Confidentiality:** You are solely responsible for maintaining the confidentiality of your account password and login credentials. Sharing accounts, passwords, or credentials with third parties is strictly prohibited and constitutes a material breach of these Terms.
4. **Unauthorized Access:** You must notify us immediately at `support@devtrackacademy.com` of any unauthorized use of your account or security breach.

---

## 3. Intellectual Property Rights

1. **Proprietary Content:** All materials available on the Platform, including but not limited to course videos, syllabus, coding exercises, projects, graphics, designs, code templates, slides, and branding elements (the "Content"), are the intellectual property of DevTrack Academy and/or its licensors.
2. **Limited License:** We grant you a personal, non-exclusive, non-transferable, revocable license to access and view the Content solely for your own personal, educational, and non-commercial learning.
3. **Prohibited Activities:** You agree not to copy, reproduce, distribute, modify, create derivative works from, publicly display, sell, or exploit any portion of the Content without our prior written consent.
4. **No Reverse Engineering:** You are prohibited from decompiling, reverse engineering, or scraping the Platform or its source files.
...
3. **Payment Processing:** All payments are processed through secure third-party payment gateways. We do not store your complete payment card or bank credentials on our servers.
4. **Refund Policy:** Purchases of digital goods, live workshops, and online courses are subject to the Refund Policy displayed at the checkout page. Unless specified otherwise, fees for digital content and live workshops are non-refundable once the course materials are accessed or the workshop has commenced.
...
1. Copy, plagiarize, or submit other students' code, projects, or work as your own.
2. Share completed assignment code or assessment solutions publicly (e.g., on public repositories or public forums) unless explicitly permitted for portfolio building.
3. Use profane, offensive, discriminatory, or harassing language in comments, community forums, discord spaces, or when interacting with instructors and other students.
4. Use automated scripts, bots, or scrapers to extract materials or data from the Platform.
...
If amicable resolution is not reached within thirty (30) days:
1. **Arbitration:** The dispute shall be referred to and finally resolved by arbitration in Hyderabad, Telangana, India, in accordance with the provisions of the **Arbitration and Conciliation Act, 1996** (as amended).
2. **Language and Arbitrator:** The tribunal shall consist of a sole arbitrator appointed mutually by both parties. The language of the arbitration shall be English.
3. **Binding Award:** The arbitral award shall be final and binding on both parties.
...
*   **Name:** Grievance Officer, DevTrack Academy
